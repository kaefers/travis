...
my $TCC_file = '/var/data/skaefer/reo_full/reo_full_TCC.csv';
#~ my $TCC_file = '/home/skaefer/sync/work/parkinson/synuclein_TCC.csv';

print '#' x 70,"\n";
print '#' x 70,"\n";
print "\t\t\tThis is TRAVIS Henchman v0.6c\n";
print '#' x 70,"\n";
print '#' x 70,"\n";
print "\n";
...
print "TRAVIS Henchman completed\n";
